...
if !isfile(figurespath * "/sim3cellgroups3stagesScRNAseqData_binarized.pdf")
    vegaheatmap(X_dicho; 
...
for t in 1:length(L_dicho)
    ...
    if !isfile(figurespath * "/sim3cellgroups3stagesScRNAseqData_tp$(t)_binarized.pdf")
    ...
    #writedlm(datapath * "sim3cellgroups3stagesScRNAseqData_tp$(t)_binarized.txt", L_dicho[t]);
    if !isfile(figurespath * "/sim3cellgroups3stagesScRNAseqData_tp$(t)_binarized_withTitle.pdf")
        vegaheatmap(L_dicho[t]; 
    ...
    if !isfile(figurespath * "/sim3cellgroups3stagesScRNAseqData_tp$(t)_standardized.pdf")
        vegaheatmap(L_st[t]; 
    ...
    if !isfile(figurespath * "/sim3cellgroups3stagesScRNAseqData_tp$(t)_standardized_rescaleVal$(rescale_factor).pdf")
        vegaheatmap(L[t]; 
...
#------------------------------
# Define and train timeBAE with transfer strategy:
#------------------------------
...
figurespath_transfer = figurespath * "/transfer/";
if !isdir(figurespath_transfer)
    # Create the folder if it does not exist
    mkdir(figurespath_transfer)
end

vegaheatmap(B'; 
    path=figurespath_transfer * "timeBAE_encoderWeightMatrix_zdim$(zdim)_epochs$(epochs)_batchsize$(batchsize).pdf", 
...
vegaheatmap(Z; 
    path=figurespath_transfer * "timeBAE_latentRep_zdim$(zdim)_epochs$(epochs)_batchsize$(batchsize).pdf", 
...
vegaheatmap(absCor_Z; 
    path=figurespath_transfer * "timeBAE_latentDimsCor_zdim$(zdim)_epochs$(epochs)_batchsize$(batchsize).pdf", 
...
vegaheatmap(B_perm'; 
    path=figurespath_transfer * "perm_timeBAE_encoderWeightMatrix_zdim$(zdim)_epochs$(epochs)_batchsize$(batchsize).pdf", 
    xlabel="Gene", ylabel="Latent Dimension", legend_title="Weight value",
    color_field="value", scheme="blueorange", save_plot=true, set_domain_mid=true,
    legend_labelFontSize=24.0, legend_titleFontSize=22.0,
    axis_labelFontSize=18.0, axis_titleFontSize=22.0
...
vegaheatmap(Z_perm; 
    path=figurespath_transfer * "perm_timeBAE_latentRep_zdim$(zdim)_epochs$(epochs)_batchsize$(batchsize).pdf", 
...
vegaheatmap(absCor_Z_perm; 
    path=figurespath_transfer * "perm_timeBAE_latentDimsCor_zdim$(zdim)_epochs$(epochs).pdf", 
    xlabel="Latent Dimension", ylabel="Latent Dimension", legend_title="Correlation",
    color_field="value", scheme="reds", save_plot=true,
    legend_labelFontSize=24.0, legend_titleFontSize=22.0,
...
for t in 1:length(L)
    vegaheatmap(B[:,(t-1)*zdim+1:(t-1)*zdim+zdim]'; 
        path=figurespath_transfer * "timeBAE_encoderWeightMatrix_tp$(t)_zdim$(zdim)_epochs$(epochs)_batchsize$(batchsize).pdf", 
...
#------------------------------
# Define and train timeBAE with zero initializations:
#------------------------------
#---Seeds for reproducibility:
modelseed = 14; 
batchseed = 5; 
...
#---Create and save plots:
figurespath_zeroinit = figurespath * "/zero_init/";
if !isdir(figurespath_zeroinit)
    # Create the folder if it does not exist
    mkdir(figurespath_zeroinit)
end

vegaheatmap(B'; 
    path=figurespath_zeroinit * "timeBAE_encoderWeightMatrix_zdim$(zdim)_epochs$(epochs)_batchsize$(batchsize).pdf", 
    xlabel="Gene", ylabel="Latent Dimension", legend_title="Weight value",
    color_field="value", scheme="blueorange", save_plot=true, set_domain_mid=true,
    legend_labelFontSize=24.0, legend_titleFontSize=22.0,
    axis_labelFontSize=18.0, axis_titleFontSize=22.0
...
vegaheatmap(Z; 
    path=figurespath_zeroinit * "timeBAE_latentRep_zdim$(zdim)_epochs$(epochs)_batchsize$(batchsize).pdf", 
    xlabel="Latent Dimension", ylabel="Cell", legend_title="Representation value",
    color_field="value", scheme="blueorange", save_plot=true, set_domain_mid=true,
    legend_labelFontSize=24.0, legend_titleFontSize=22.0,
    axis_labelFontSize=18.0, axis_titleFontSize=22.0
...
vegaheatmap(absCor_Z; 
    path=figurespath_zeroinit * "timeBAE_latentDimsCor_zdim$(zdim)_epochs$(epochs)_batchsize$(batchsize).pdf", 
    xlabel="Latent Dimension", ylabel="Latent Dimension",  legend_title="Correlation",
    color_field="value", scheme="reds", save_plot=true,
    legend_labelFontSize=24.0, legend_titleFontSize=22.0,
    axis_labelFontSize=18.0, axis_titleFontSize=22.0
...
vegaheatmap(B_perm'; 
    path=figurespath_zeroinit * "perm_timeBAE_encoderWeightMatrix_zdim$(zdim)_epochs$(epochs)_batchsize$(batchsize).pdf", 
    xlabel="Gene", ylabel="Latent Dimension", legend_title="Weight value",
    color_field="value", scheme="blueorange", save_plot=true, set_domain_mid=true,
    legend_labelFontSize=24.0, legend_titleFontSize=22.0,
    axis_labelFontSize=18.0, axis_titleFontSize=22.0
...
vegaheatmap(Z_perm; 
    path=figurespath_zeroinit * "perm_timeBAE_latentRep_zdim$(zdim)_epochs$(epochs)_batchsize$(batchsize).pdf", 
    xlabel="Latent Dimension", ylabel="Cell", legend_title="Representation value", Width=400,
    color_field="value", scheme="blueorange", save_plot=true, set_domain_mid=true,
    legend_labelFontSize=24.0, legend_titleFontSize=16.0,
    axis_labelFontSize=18.0, axis_titleFontSize=22.0
...
vegaheatmap(absCor_Z_perm; 
    path=figurespath_zeroinit * "perm_timeBAE_latentDimsCor_zdim$(zdim)_epochs$(epochs).pdf", 
    xlabel="Latent Dimension", ylabel="Latent Dimension", legend_title="Correlation",
    color_field="value", scheme="reds", save_plot=true,
    legend_labelFontSize=24.0, legend_titleFontSize=22.0,
    axis_labelFontSize=20.0, axis_titleFontSize=22.0
...
for t in 1:length(L)
    vegaheatmap(B[:,(t-1)*zdim+1:(t-1)*zdim+zdim]'; 
        path=figurespath_zeroinit * "timeBAE_encoderWeightMatrix_tp$(t)_zdim$(zdim)_epochs$(epochs)_batchsize$(batchsize).pdf", 
        xlabel="Gene", ylabel="Latent Dimension", legend_title="Weight",
        color_field="value", scheme="blueorange", save_plot=true, set_domain_mid=true,
        legend_labelFontSize=24.0, legend_titleFontSize=22.0,
        axis_labelFontSize=18.0, axis_titleFontSize=22.0
